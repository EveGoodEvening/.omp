/plan help me write a "/goal" prompt, so that I could directly copy-and-paste, to implement tasks from design doc $1 and progress tracker $2 via an iterative implement-review loop.
